<%-- 
    Document   : NonVerbal1form
    Created on : 01-Sep-2024, 4:20:24 pm
...
<body>
    <header>
        <div class="logo"><a href="NonVerbal1form.jsp"><b>Apti<span style="color: #bfbfbf">Guru</span></b></a></div>
    ...
    %>
    <div class="container">
        <h2>NonVerbal Reasoning - Easy</h2>
        ...
        <form id="testForm">
            ...
            <div class="question">
                ...
                <div class="options">
                    ...
                    <div class="description hidden" style="color:#ff3333">Correct sequence: 1. Key, 3. Lock, 2. Door, 4. Room, 5. Switch on.</div>
